      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-[var(--foreground-muted)] text-sm font-sans">
            Log in to your Echo<span className="text-[var(--primary)] font-bold">Mind</span> account
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="login-email" className="block text-xs font-heading font-semibold uppercase tracking-wider text-[var(--foreground-muted)] mb-1.5">
              Email
            </label>
            <input
              id="login-email"
          ...
          <div>
            <label htmlFor="login-password" className="block text-xs font-heading font-semibold uppercase tracking-wider text-[var(--foreground-muted)] mb-1.5">
              Password
            </label>
            <input
              id="login-password"
